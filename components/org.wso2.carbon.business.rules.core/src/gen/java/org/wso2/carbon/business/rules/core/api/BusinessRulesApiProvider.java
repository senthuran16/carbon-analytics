...
//    @Reference(service = BusinessRulesApiService.class,
//            cardinality = ReferenceCardinality.MANDATORY,
//            policy = ReferencePolicy.DYNAMIC,
//            unbind = "unsetBusinessRulesProvider")
//    protected void setBusinessRulesProvider(BusinessRulesApiService businessRulesMetadataProvider) {
//        this.businessRulesProvider = businessRulesMetadataProvider;
//        LOGGER.debug("BusinessRulesProvider '{}' registered.", businessRulesMetadataProvider.getClass().getName());
//    }
//
